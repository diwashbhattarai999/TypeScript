...
//Decorators can have return value but only with methods and accessors not all of them. But the decorators on parameters and properties can also have return value but Typescript will ignore that.
